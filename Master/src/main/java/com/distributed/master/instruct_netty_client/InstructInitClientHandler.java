...
public class InstructInitClientHandler extends SimpleChannelInboundHandler<InstructInit> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, InstructInit instructionInit) throws Exception {
        System.out.println("\t\t收到服务端" + instructionInit.getInstruction());
    }
